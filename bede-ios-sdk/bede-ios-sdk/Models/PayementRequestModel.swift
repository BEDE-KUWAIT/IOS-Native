...
//        UUID().uuidString
        ...
        let hashMacvalue:String = "\(merchantDetails.merchantID)|\(marchantTransactionID)|\(merchantDetails.successURL)|\(merchantDetails.failureURL)|\(10)|GEN|\(sdk.secretKey)|\(txnHDR)"
        print(hashMacvalue)
...
public struct TransactionDetails: Codable {
   ...
   public init(subMerchUid: String, amount: Float) {
        self.subMerchUid = subMerchUid
        self.amount = amount
    }
...
public struct PayementRequestResponseModel: Codable {
