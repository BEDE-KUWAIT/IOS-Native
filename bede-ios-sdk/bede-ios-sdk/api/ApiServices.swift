...
public struct Apiservices {
    ...
    public func requestLink(request:PaymentRequestModel) async throws -> PayementRequestResponseModel {
        /// create Url
        var url:String  = ""
        ...
        do {
            let decoder = JSONDecoder()
            return try decoder.decode(PayementRequestResponseModel.self, from: data)
        } catch {
            throw  ApiServeiceError.invalidData
        }
    }
